  ...
  return (
    <section className="relative border-b-4 border-[#1a1a1a] bg-black px-6 py-20 font-mono text-gray-400 md:px-12 md:py-32">
      <div className="mx-auto max-w-5xl">
        <div className="relative border-4 border-[#1a1a1a] bg-[#050505] p-6 md:p-10">
          ...
          <div className="mb-10 flex items-center justify-between">
            ...
            <div className="flex gap-1">
               {[...Array(5)].map((_, i) => (
                 <div key={i} className="h-8 w-1 bg-[#1a1a1a]" style={{ height: `${20 + Math.random() * 40}px` }} />
               ))}
            </div>
          </div>

          <div className="group relative border-2 border-[#1a1a1a] p-2 transition-all hover:border-[#ff5c00]">
            <div className="absolute inset-0 z-10 pointer-events-none border border-white/5" />
            
            <div className="relative z-0 opacity-90 transition-opacity group-hover:opacity-100">
          ...
          <div className="mt-8 flex items-center justify-between">
             <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] tracking-widest uppercase text-[#333]">Streaming: Live_Data</span>
             </div>
             <span className="text-[10px] tracking-widest uppercase text-[#333]">Module: SC-909-IFRAME</span>
          </div>
        </div>
      </div>
    </section>
