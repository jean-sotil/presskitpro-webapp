...
import { PhotoGalleryRender } from './PhotoGalleryRender';
...
describe('PhotoGalleryRender variant=editorial-grid', () => {
  it('returns null when there are no items', async () => {
    const { container } = await renderAsync(
      PhotoGalleryRender({ variant: 'editorial-grid', bundle: makeBundle([]) }),
    );
