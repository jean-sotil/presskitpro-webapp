...
import { InstagramFeedNuclearWinter } from './nuclear-winter/InstagramFeedRender.nuclear-winter';
...
export function InstagramFeedRender({
  ...
  if (preset?.id === 'nuclear-winter') return <InstagramFeedNuclearWinter bundle={bundle} />;
