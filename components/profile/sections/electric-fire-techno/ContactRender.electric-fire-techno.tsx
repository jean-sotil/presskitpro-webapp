 ...
 * a fire-orange top edge gradient and a lightning-bolt divider.
 */
export function ContactElectricFireTechno({ bundle }: { bundle: EditorBundle }) {
  ...
  useGSAP(
    () => {
      ...
      // 1. Header and info entrance
      tl.fromTo(
        '[data-fire-contact-content] > *',
        { opacity: 0, y: 20 },
    ...
    >
      ...
      >
        ...
        {formEnabled && profileId > 0 ? (
          <div data-fire-contact-form className="mx-auto mt-10 max-w-xl text-left">
