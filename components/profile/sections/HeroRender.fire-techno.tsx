 ...
 */
export function HeroFireTechno({ bundle }: { bundle: EditorBundle }) {
    ...
    >
      <div className="relative h-[78vh] min-h-[560px] w-full md:h-[88vh]">
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-12 md:px-12 md:pb-20">
          ...
          {tagline ? (
            <p className="mt-6 max-w-2xl text-sm uppercase tracking-[0.18em] text-text-muted md:text-base">
              {tagline}
            </p>
          ) : null}
          {ctaUrl ? (
