...
- **Why marquee/ticker as a decoration, not a section?** Decorations are non-content adornments (dividers, ticker bands, frames) that don't need editor configuration — they're owned by the preset, not the artist. The artist's _content_ is the same across presets; the _chrome_ is what changes.
